...
<%
    ...
    request.setAttribute("site",new _HashMap<String,String>().add("name","虎牙直播")
            .add("keywords","虎牙直播,接口文档管理,接口平台,api,api管理,api测试,接口文档工具,接口演示,rest,restful,rest api,接口测试,postman,文档管理,websocket在线测试")
    );
    //扩展功能
